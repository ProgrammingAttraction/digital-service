...
Adminroute.get('/dashboard/overview', authenticateAdmin, async (req, res) => {
    try {
...
// ==================== SERVICE ORDER COUNT ROUTE ====================

// GET service order count - simple: service name and count
Adminroute.get('/orders/service-count', authenticateAdmin, async (req, res) => {
    try {
        const serviceStats = await Order.aggregate([
            ...
            {
                $sort: { count: -1 } // Most ordered first
            },
            {
                $project: {
                    serviceName: '$_id',
...
console.log(serviceStats)
        ...
        console.error('Get service order count error:', error);
        res.status(500).json({ 
            success: false,
            error: 'Server error while fetching service order count' 
        });
    }
});
// GET admin profile (authenticated admin can view their own profile)
Adminroute.get('/profile', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.put('/update-password', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.put('/profile', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.put('/:id', authenticateAdmin, authorizeRoles('superadmin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/users', authenticateAdmin,async (req, res) => {
    try {
...
Adminroute.get('/active-users', authenticateAdmin,async (req, res) => {
    try {
        // Execute query with pagination
...
Adminroute.get('/inactive-users', authenticateAdmin,async (req, res) => {
    try {
        // Execute query with pagination
...
Adminroute.get('/users/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/users', authenticateAdmin,async (req, res) => {
    try {
        const { 
            fullname, 
            email, 
...
// UPDATE user by ID
Adminroute.put('/users/:id', authenticateAdmin,async (req, res) => {
    try {
        const { id } = req.params;
        const { 
            fullname, 
...
// DELETE user by ID
Adminroute.delete('/users/:id', authenticateAdmin,async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.delete('/users', authenticateAdmin,async (req, res) => {
    try {
...
Adminroute.put('/users/:id/status', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/users/:id/add-balance', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/users/:id/subtract-balance', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const { amount, notes } = req.body;
...
// GET user statistics
Adminroute.get('/users/stats/overview', authenticateAdmin,async (req, res) => {
    try {
...
Adminroute.put('/users/:id/password', authenticateAdmin,async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/deposit-methods', 
    authenticateAdmin, 
...
Adminroute.put('/deposit-methods/:id', 
    authenticateAdmin, 
    authorizeRoles('superadmin', 'admin'),
    upload.single('image'),
    async (req, res) => {
...
Adminroute.get('/deposit-methods', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/deposit-methods/active/:accountType', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/deposit-methods/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/deposit-methods/account-types', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.patch('/deposit-methods/:id', 
    authenticateAdmin, 
    authorizeRoles('superadmin', 'admin'),
    upload.single('image'),
    async (req, res) => {
...
Adminroute.delete('/deposit-methods/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/deposit-methods/:id/image', async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.patch('/deposit-methods/:id/image', 
    authenticateAdmin, 
    authorizeRoles('superadmin', 'admin'),
    upload.single('image'),
    async (req, res) => {
...
Adminroute.delete('/deposit-methods/:id/image', 
    authenticateAdmin, 
    authorizeRoles('superadmin', 'admin'),
    async (req, res) => {
        try {
...
Adminroute.patch('/deposit-methods/:id/status', 
    authenticateAdmin, 
    authorizeRoles('superadmin', 'admin'),
    async (req, res) => {
        try {
...
Adminroute.patch('/deposit-methods/:id/toggle-status', 
    authenticateAdmin, 
    authorizeRoles('superadmin', 'admin'),
    async (req, res) => {
        try {
...
// GET all bonuses
Adminroute.get('/bonuses', authenticateAdmin, async (req, res) => {
    try {
...
// GET active bonuses
Adminroute.get('/bonuses/active', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/bonuses/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
// CREATE new bonus
Adminroute.post('/bonuses', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { 
            title, 
            minimumDeposit, 
...
// UPDATE bonus by ID
Adminroute.put('/bonuses/:id', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
        const { 
            title, 
...
// DELETE bonus by ID
Adminroute.delete('/bonuses/:id', authenticateAdmin, authorizeRoles('superadmin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.patch('/bonuses/:id/toggle-status', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.delete('/bonuses', authenticateAdmin, authorizeRoles('superadmin'), async (req, res) => {
    try {
...
Adminroute.get('/bonuses/stats/overview', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
...
Adminroute.get('/deposits', authenticateAdmin, async (req, res) => {
    try {
        const {
            page = 1,
            limit = 20,
...
Adminroute.get('/deposits/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/deposits/stats/overview', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.post('/deposits/:id/approve', authenticateAdmin,async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/deposits/:id/reject', authenticateAdmin,async (req, res) => {
    try {
        const { id } = req.params;
        const { adminNotes } = req.body;
...
Adminroute.post('/deposits', authenticateAdmin,async (req, res) => {
    try {
        const {
            userId,
            depositMethodId,
...
Adminroute.delete('/deposits/:id', authenticateAdmin,async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.put('/deposits/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const {
            accountNumber,
...
Adminroute.get('/users/:userId/deposits', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.post('/deposits/bulk-approve', authenticateAdmin,async (req, res) => {
    try {
...
Adminroute.post('/deposits/bulk-reject', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/services', authenticateAdmin, async (req, res) => {
    try {
        const {
            page = 1,
            limit = 20,
...
// GET active services
Adminroute.get('/services/active', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/services/featured', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/services/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
// CREATE new service
Adminroute.post('/services', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { 
            workName, 
            workNameEnglish, 
...
Adminroute.put('/services/:id', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
        const { 
            workName, 
...
Adminroute.post('/services/:id/fields', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.put('/services/:id/fields/:fieldIndex', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
...
Adminroute.delete('/services/:id/fields/:fieldIndex', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id, fieldIndex } = req.params;
...
Adminroute.put('/services/:id/fields/reorder', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.delete('/services/:id', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.patch('/services/:id/toggle-status', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.patch('/services/:id/toggle-featured', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/services/stats/overview', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
...
// GET services by work type
Adminroute.get('/services/type/:workType', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.put('/services/reorder', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
...
Adminroute.put('/services/bulk/status', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
...
Adminroute.delete('/services', authenticateAdmin, authorizeRoles('superadmin'), async (req, res) => {
    try {
        const { confirmation } = req.body;
...
Adminroute.get('/services/:id/fields', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/orders/:id/download-pdf', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
// SUBMIT PDF for order
Adminroute.post('/orders/:id/submit-pdf', 
    authenticateAdmin,
    ...
    async (req, res) => {
        try {
            ...
            // Determine if order will be completed
            const orderWillBeCompleted = order.status === 'pending' || order.status === 'processing';
            ...
            // CREATE NOTIFICATION
            let notificationType = 'admin_submission';
            let notificationMessage = `Admin has submitted PDF output for order ${order.orderId}`;
            
            if (orderWillBeCompleted) {
                notificationType = 'order_completed';
                notificationMessage = `Order ${order.orderId} has been completed`;
            }
            ...
            try {
                const notification = new Notification({
                    ...
                    serviceName: updatedOrder.service?.workName || order.service?.workName || 'Service',
                ...
                if (io) {
                    ...
                    io.to(`user_${order.user}`).emit('new_notification', {
                        type: 'success',
                        message: notificationMessage,
                        notification: {
                    ...
                    // Also emit to admin panel if needed
                    io.to('admin_panel').emit('order_updated', {
                        orderId: order.orderId,
...
Adminroute.post('/orders/:id/submit-text', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        ...
        // CREATE NOTIFICATION
        let notificationType = 'admin_submission';
        let notificationMessage = `Admin has submitted text output for order ${order.orderId}`;
...
Adminroute.put('/orders/:id/notes', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const { adminNotes } = req.body;
...
Adminroute.post('/orders/:id/cancel', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.delete('/orders/:id/pdf', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.delete('/orders/:id/text', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/orders/:id/complete', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const { adminNotes } = req.body;
...
// Add these imports at the top of your file, after other imports

// If you don't have socket.io setup, you'll need to pass it through middleware
// For this example, I'll assume you have a global io instance or pass it through app.locals
// You might need to modify based on your socket.io setup

Adminroute.put('/orders/:id/submit-output', 
    authenticateAdmin,
    uploadOrderFile.single('pdfFile'),
    async (req, res) => {
        try {
            ...
            let notificationType = 'admin_notes';
            ...
            if (order.orderType === 'pdf_file') {
                ...
                notificationType = 'admin_submission';
                notificationMessage = `Admin has submitted PDF output for order ${order.orderId}`;
                ...
                notificationType = 'admin_submission';
                notificationMessage = `Admin has submitted text output for order ${order.orderId}`;
                ...
                notificationType = 'admin_notes';
                notificationMessage = `Admin has added notes to order ${order.orderId}`;
            }
            ...
            if (order.status === 'pending' || order.status === 'processing') {
                ...
                // If order is completed, change notification type
                notificationType = 'order_completed';
                notificationMessage = `Order ${order.orderId} has been completed`;
            }
            ...
            try {
                ...
                // You can access the io instance through req.app.get('io') or globally
                const io = req.app.get('io') || global.io;
...
Adminroute.get('/orders/:id/output', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/orders/:id/view-pdf', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/orders', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/orders/pending', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/orders/cancelled', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/orders/completed', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/orders/status/:status', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/orders/type/:orderType', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/orders/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/orders/orderId/:orderId', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/orders/stats/overview', authenticateAdmin, async (req, res) => {
    try {
        // Get today's date range
        const today = new Date();
        today.setHours(0, 0, 0, 0);
...
// UPDATE order status
Adminroute.put('/orders/:id/status', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.put('/orders/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const { 
            status,
...
// DELETE order by ID
Adminroute.delete('/orders/:id', authenticateAdmin,async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/users/:userId/orders', authenticateAdmin, async (req, res) => {
    try {
        const { userId } = req.params;
...
Adminroute.get('/services/:serviceId/orders', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.put('/orders/bulk/status', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/orders/pending/count', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/orders/recent', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/pricelist', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/pricelist/active', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/pricelist/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/pricelist', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { 
            name, 
            price = 0,
...
Adminroute.put('/pricelist/:id', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
        const { 
            name, 
...
Adminroute.patch('/pricelist/:id/price', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
// BULK update prices
Adminroute.put('/pricelist/bulk/price', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
...
Adminroute.patch('/pricelist/:id/toggle-status', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.delete('/pricelist/:id', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/pricelist/bulk-delete', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { ids } = req.body;
...
Adminroute.get('/transactions', authenticateAdmin, async (req, res) => {
    try {
        const {
            page = 1,
            limit = 20,
...
Adminroute.delete('/transactions/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/balance-history', authenticateAdmin, async (req, res) => {
    try {
        const {
            page = 1,
            limit = 20,
...
Adminroute.get('/balance-history/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.get('/social-media', authenticateAdmin, async (req, res) => {
  try {
...
Adminroute.get('/social-media/active', async (req, res) => {
  try {
...
Adminroute.post('/social-media', authenticateAdmin, async (req, res) => {
  try {
...
Adminroute.put('/social-media/:id', authenticateAdmin, async (req, res) => {
  try {
    const { id } = req.params;
...
Adminroute.delete('/social-media/:id', authenticateAdmin, async (req, res) => {
  try {
    const { id } = req.params;
...
// TOGGLE active status
Adminroute.patch('/social-media/:id/toggle', authenticateAdmin, async (req, res) => {
  try {
    const { id } = req.params;
...
// GET all notices
Adminroute.get('/notices', authenticateAdmin, async (req, res) => {
  try {
...
// GET active notices
Adminroute.get('/notices/active', authenticateAdmin, async (req, res) => {
  try {
...
Adminroute.get('/notices/check-defaults', authenticateAdmin, async (req, res) => {
  try {
...
Adminroute.post('/notices/save-defaults', authenticateAdmin, async (req, res) => {
  try {
...
Adminroute.get('/notices/:id', authenticateAdmin, async (req, res) => {
  try {
    const { id } = req.params;
...
// CREATE new notice
Adminroute.post('/notices', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
  try {
    const { 
      serviceName, 
      notice,
...
// UPDATE notice by ID
Adminroute.put('/notices/:id', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
  try {
    const { id } = req.params;
    const { 
      serviceName, 
...
// DELETE notice by ID
Adminroute.delete('/notices/:id', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
  try {
    const { id } = req.params;
...
Adminroute.patch('/notices/:id/toggle-status', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
  try {
    const { id } = req.params;
...
Adminroute.get('/notices/stats/overview', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
  try {
...
// GET all sub admins
Adminroute.get('/subadmins', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/subadmins/active', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/subadmins/inactive', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.get('/subadmins/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/subadmins', authenticateAdmin, async (req, res) => {
    try {
        const { name, email, password, commission = 0, balance = 0, active = true } = req.body;
        ...
        const subAdminData = {
            ...
            totalEarnings: Number(balance), // Initial balance counts as earnings
...
Adminroute.put('/subadmins/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const { name, email, commission, balance, active } = req.body;
...
Adminroute.patch('/subadmins/:id/commission', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
// ADD BALANCE to sub admin
Adminroute.post('/subadmins/:id/balance/add', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        ...
        subadmin.balance+=amountValue;
        subadmin.save();
        res.json({
            success: true,
            message: `Successfully added ${amountValue} to balance`,
            data: {
        ...
        res.status(500).json({ 
            success: false,
            error: error.message || 'Server error while adding balance'
        });
    }
});

// DEDUCT BALANCE from sub admin
Adminroute.post('/subadmins/:id/balance/deduct', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const { amount, description = 'Balance deducted by admin' } = req.body;
        ...
        if (subadmin.balance < amountValue) {
            return res.status(400).json({ 
                success: false,
                error: `Insufficient balance. Current balance: ${subadmin.balance}` 
            });
        }
        ...
        res.json({
            success: true,
            message: `Successfully deducted ${amountValue} from balance`,
            data: {
                subadmin: subadmin.getPublicProfile(),
            }
        });
        ...
        res.status(500).json({ 
            success: false,
            error: error.message || 'Server error while deducting balance'
        });
    }
});

// SET BALANCE for sub admin
Adminroute.put('/subadmins/:id/balance/set', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const oldBalance = subadmin.balance;
        subadmin.balance = balanceValue;
        await subadmin.save();
        
        res.json({
            success: true,
            message: `Balance updated from ${oldBalance} to ${balanceValue}`,
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while setting balance'
        });
    }
});

// GET sub admin balance
Adminroute.get('/subadmins/:id/balance', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const subadmin = await SubAdmin.findById(id).select('name email balance totalEarnings totalWithdrawn');
...
Adminroute.patch('/subadmins/:id/toggle-status', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.put('/subadmins/:id/password', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.delete('/subadmins/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.delete('/subadmins', authenticateAdmin, async (req, res) => {
    try {
        const { confirmation } = req.body;
...
Adminroute.get('/subadmins/stats/overview', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.put('/subadmins/bulk/commission', authenticateAdmin, async (req, res) => {
    try {
...
Adminroute.put('/subadmins/bulk/status', authenticateAdmin, async (req, res) => {
    try {
...
// BULK add balance to sub admins
Adminroute.post('/subadmins/bulk/balance/add', authenticateAdmin, async (req, res) => {
    try {
        const { subadminIds, amount, description = 'Bulk balance addition by admin' } = req.body;
        ...
        // Process each sub admin individually to ensure proper tracking
        for (const id of validIds) {
            const subadmin = await SubAdmin.findById(id);
            if (subadmin) {
                await subadmin.addBalance(amountValue, description);
                results.push({
                    id: subadmin._id,
                    name: subadmin.name,
                    email: subadmin.email,
                    newBalance: subadmin.balance
                });
            }
        }
        ...
        res.json({
            success: true,
            message: `Successfully added ${amountValue} to balance for ${results.length} sub admin(s)`,
            data: {
        ...
        console.error('Bulk add balance error:', error);
        res.status(500).json({
            success: false,
            error: 'Server error while bulk adding balance'
        });
    }
});

// SEARCH sub admins with filters
Adminroute.get('/subadmins/search/filter', authenticateAdmin, async (req, res) => {
    try {
        const { 
            name, 
            email, 
        ...
        if (minCommission !== undefined || maxCommission !== undefined) {
            query.commission = {};
            if (minCommission !== undefined) query.commission.$gte = Number(minCommission);
            if (maxCommission !== undefined) query.commission.$lte = Number(maxCommission);
        }
        
        if (minBalance !== undefined || maxBalance !== undefined) {
            query.balance = {};
            if (minBalance !== undefined) query.balance.$gte = Number(minBalance);
            if (maxBalance !== undefined) query.balance.$lte = Number(maxBalance);
        }
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while searching sub admins'
        });
    }
});
...
// GET all menu items
Adminroute.get('/menulist', authenticateAdmin, async (req, res) => {
    try {
        const { search, category, isActive, sortBy = 'order', sortOrder = 'asc' } = req.query;

        // Build filter
        const filter = {};
        
        if (category && ['order', 'clone', 'auto', 'mobile', 'form', 'passport', 'other'].includes(category)) {
        ...
        // Get menu items
        const menuList = await Menu.find(filter).sort(sort);
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while fetching menu list' 
        });
    }
});

// GET active menu items
Adminroute.get('/menulist/active', authenticateAdmin, async (req, res) => {
    try {
        const menuList = await Menu.getActiveMenus();
        ...
        console.error('Get active menu list error:', error);
        res.status(500).json({ 
            success: false,
            error: 'Server error while fetching active menu list' 
        });
    }
});

// GET menu items by category
Adminroute.get('/menulist/category/:category', authenticateAdmin, async (req, res) => {
    try {
        const { category } = req.params;
        
        const validCategories = ['order', 'clone', 'auto', 'mobile', 'form', 'passport', 'other'];
        if (!validCategories.includes(category)) {
            return res.status(400).json({ 
                success: false,
                error: 'Invalid category. Must be one of: order, clone, auto, mobile, form, passport, other' 
            });
        }
        
        const menuList = await Menu.getActiveMenusByCategory(category);
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while fetching menu by category' 
        });
    }
});

// GET menu items grouped by category
Adminroute.get('/menulist/grouped', authenticateAdmin, async (req, res) => {
    try {
        const groupedMenus = await Menu.getMenusByCategory();
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while fetching grouped menus' 
        });
    }
});

// GET single menu item by ID
Adminroute.get('/menulist/:id', authenticateAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/menulist', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { 
            name, 
            category = 'other',
...
Adminroute.put('/menulist/:id', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
        const { 
            name, 
...
Adminroute.patch('/menulist/:id/toggle-status', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
        ...
        res.json({
            success: true,
            message: `Menu item status changed to ${newStatus ? 'active' : 'inactive'}`,
            data: updatedMenuItem
        });
    } catch (error) {
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while toggling menu status' 
        });
    }
});

// DELETE menu item by ID
Adminroute.delete('/menulist/:id', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { id } = req.params;
...
Adminroute.post('/menulist/bulk-delete', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        const { ids } = req.body;
        ...
        if (!ids || !Array.isArray(ids) || ids.length === 0) {
            return res.status(400).json({
                success: false,
                error: 'Array of menu IDs is required'
            });
        }
        ...
        if (validIds.length !== ids.length) {
            return res.status(400).json({
                success: false,
                error: 'Invalid menu IDs found'
            });
        }
        
        // Delete multiple items
        const result = await Menu.bulkDelete(validIds);
        
        res.json({
            success: true,
            message: `Successfully deleted ${result.deletedCount} menu item(s)`,
            data: {
                deletedCount: result.deletedCount
            }
        });
        ...
        res.status(500).json({
            success: false,
            error: 'Server error while bulk deleting menu items'
        });
    }
});

// BULK update menu status
Adminroute.put('/menulist/bulk/status', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        ...
        // Validate all IDs
        const validIds = menuIds.filter(id => mongoose.Types.ObjectId.isValid(id));
        if (validIds.length !== menuIds.length) {
            return res.status(400).json({
                success: false,
                error: 'Invalid menu IDs found'
            });
        ...
        // Update menus
        const result = await Menu.bulkUpdateStatus(validIds, isActive);
        
        res.json({
            success: true,
            message: `Successfully updated ${result.modifiedCount} menu item(s) to ${isActive ? 'active' : 'inactive'}`,
            data: {
                modifiedCount: result.modifiedCount
            }
        });
        ...
        res.status(500).json({
            success: false,
            error: 'Server error while bulk updating menu status'
        });
    }
});

// GET menu statistics
Adminroute.get('/menulist/stats/overview', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while fetching menu statistics' 
        });
    }
});

// REORDER menu items
Adminroute.put('/menulist/reorder', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        ...
        if (!orderUpdates || !Array.isArray(orderUpdates) || orderUpdates.length === 0) {
            return res.status(400).json({
                success: false,
                error: 'Array of order updates is required'
            });
        }
        ...
        for (const update of orderUpdates) {
            ...
            if (update.order === undefined || isNaN(update.order)) {
                invalidUpdates.push({
                    id: update.id,
        ...
        if (validatedUpdates.length === 0) {
            return res.status(400).json({
                success: false,
                error: 'No valid order updates provided',
                details: invalidUpdates
            });
        }
        
        // Bulk update orders
        const result = await Menu.bulkUpdateOrder(validatedUpdates);
        
        res.json({
            success: true,
            message: `Successfully reordered ${result.modifiedCount} menu item(s)`,
            data: {
                modifiedCount: result.modifiedCount,
                invalidUpdates: invalidUpdates
            }
        ...
        res.status(500).json({
            success: false,
            error: 'Server error while reordering menus'
        });
    }
});

// IMPORT default menus (for initial setup)
Adminroute.post('/menulist/import-defaults', authenticateAdmin, authorizeRoles('superadmin', 'admin'), async (req, res) => {
    try {
        ...
        if (!menus || !Array.isArray(menus) || menus.length === 0) {
            return res.status(400).json({ 
                success: false,
                error: 'Array of menus is required' 
            });
        }
        
        // Check if any menus already exist
        const existingMenus = await Menu.find({
            name: { $in: menus.map(m => m.name) }
        });
        
        const existingMenuNames = existingMenus.map(m => m.name);
        const newMenus = menus.filter(m => !existingMenuNames.includes(m.name));
        
        if (newMenus.length === 0) {
            return res.json({
                success: true,
                message: 'All default menus already exist',
                addedCount: 0
            });
        }
        
        // Save new menus
        const menusToSave = newMenus.map(menu => ({
            name: menu.name,
        ...
        const result = await Menu.insertMany(menusToSave);
        
        res.json({
            success: true,
            message: `Successfully added ${result.length} default menus`,
            addedCount: result.length,
            data: result
        });
        
    } catch (error) {
        console.error('Import default menus error:', error);
        res.status(500).json({ 
            success: false,
            error: 'Server error while importing default menus' 
        });
    }
});
...
// Multer setup for zero return files
const zeroReturnStorage = multer.diskStorage({
    destination: function (req, file, cb) {
        const uploadDir = path.join(__dirname, '../public/uploads/zero-return');
        if (!fs.existsSync(uploadDir)) {
            fs.mkdirSync(uploadDir, { recursive: true });
        }
        cb(null, uploadDir);
    ...
    filename: function (req, file, cb) {
        const uniqueSuffix = Date.now() + '-' + Math.round(Math.random() * 1E9);
        const ext = path.extname(file.originalname);
        cb(null, 'zero-return-' + uniqueSuffix + ext);
    }
});

const uploadZeroReturn = multer({
    storage: zeroReturnStorage,
    limits: { fileSize: 10 * 1024 * 1024 } // 10MB
}).array('files', 3); // Accept up to 3 files with field name 'files'

// UPDATE zero return order with files
Adminroute.put('/orders/:id/zero-return', 
    authenticateAdmin,
    uploadZeroReturn,
    async (req, res) => {
        try {
            ...
            if (req.files && req.files.length > 0) {
                req.files.forEach(file => {
                    uploadedFiles.push({
                        ...
                        filePath: '/uploads/zero-return/' + file.filename,
                        fileSize: file.size,
            ...
            // Update order with zero return documents
            ...
            if (order.status === 'pending' || order.status === 'processing') {
                ...
                order.completedBy = req.admin.id || req.admin._id;
            }
            ...
            res.json({
                success: true,
                message: 'Zero return documents uploaded successfully',
                data: updatedOrder
            });
            
        } catch (error) {
            console.error('Update zero return error:', error);
            ...
            res.status(500).json({ 
                success: false,
                error: 'Server error while updating zero return order' 
            });
        }
    }
);
...
// GET current status
Adminroute.get('/auto-method', authenticateAdmin, async (req, res) => {
    try {
        const autoMethod = await AutoMethod.getSettings();
        res.json({
            success: true,
            status: autoMethod.status
        });
    } catch (error) {
...
Adminroute.put('/auto-method', authenticateAdmin, async (req, res) => {
    try {
        const { status } = req.body;
        
        let autoMethod = await AutoMethod.findOne();
        
        if (!autoMethod) {
            autoMethod = new AutoMethod({ status: status || false });
        } else {
            autoMethod.status = status === true || status === 'true';
        }
        
        await autoMethod.save();
        
        res.json({
            success: true,
            message: `Auto method turned ${autoMethod.status ? 'ON' : 'OFF'}`,
            status: autoMethod.status
        });
    } catch (error) {
        res.status(500).json({ success: false, error: 'Server error' });
...
Adminroute.patch('/auto-method/toggle', authenticateAdmin, async (req, res) => {
    try {
        let autoMethod = await AutoMethod.findOne();
        
        if (!autoMethod) {
            autoMethod = new AutoMethod({ status: true });
        } else {
            autoMethod.status = !autoMethod.status;
        }
...
Adminroute.get('/website-status', authenticateAdmin, async (req, res) => {
    try {
        const status = await WebsiteStatus.getStatus();
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while fetching website status' 
        });
    }
});

// UPDATE website status (simple true/false)
Adminroute.put('/website-status', authenticateAdmin, async (req, res) => {
    try {
        const { isActive, message } = req.body;
        
        // Validate isActive is provided and is boolean
        if (isActive === undefined) {
            return res.status(400).json({ 
                success: false,
                error: 'isActive field is required (true/false)' 
            });
        }
        ...
        websiteStatus.isActive = activeStatus;
        
        if (message !== undefined) {
            websiteStatus.message = message;
        }
        
        websiteStatus.updatedBy = req.admin.id || req.admin._id;
        websiteStatus.updatedAt = new Date();
        
        await websiteStatus.save();
        
        res.json({
            success: true,
            message: `Website is now ${activeStatus ? 'ACTIVE' : 'INACTIVE (Maintenance Mode)'}`,
            data: {
                isActive: websiteStatus.isActive,
                message: websiteStatus.message,
                updatedAt: websiteStatus.updatedAt
            }
        });
    } catch (error) {
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while updating website status' 
        });
    }
});

// TOGGLE website status (simple toggle)
Adminroute.patch('/website-status/toggle', authenticateAdmin, async (req, res) => {
    try {
        let websiteStatus = await WebsiteStatus.findOne();
        ...
        // Toggle the status
        websiteStatus.isActive = !websiteStatus.isActive;
        websiteStatus.updatedBy = req.admin.id || req.admin._id;
        websiteStatus.updatedAt = new Date();
        ...
        res.json({
            success: true,
            message: `Website status toggled to: ${websiteStatus.isActive ? 'ACTIVE' : 'MAINTENANCE'}`,
            data: {
                isActive: websiteStatus.isActive,
                message: websiteStatus.message,
                updatedAt: websiteStatus.updatedAt
        ...
        console.error('Toggle website status error:', error);
        res.status(500).json({ 
            success: false,
            error: 'Server error while toggling website status' 
        });
    }
});

// UPDATE maintenance message only
Adminroute.patch('/website-status/message', authenticateAdmin, async (req, res) => {
    try {
        ...
        websiteStatus.message = message.trim();
        websiteStatus.updatedBy = req.admin.id || req.admin._id;
        websiteStatus.updatedAt = new Date();
...
// ==================== REGISTRATION PAGE MANAGEMENT ROUTES ====================
const RegistrationStatus = require("../models/RegistrationStatus");

// GET current registration status
Adminroute.get('/registration-status', authenticateAdmin, async (req, res) => {
    try {
        const status = await RegistrationStatus.getStatus();
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while fetching registration status' 
        });
    }
});

// UPDATE registration status (simple true/false)
Adminroute.put('/registration-status', authenticateAdmin, async (req, res) => {
    try {
        const { isActive, message } = req.body;
        ...
        let registrationStatus = await RegistrationStatus.findOne();
        
        if (!registrationStatus) {
            registrationStatus = new RegistrationStatus();
        }
        
        registrationStatus.isActive = activeStatus;
        
        if (message !== undefined && message.trim() !== '') {
            registrationStatus.message = message.trim();
        }
        
        registrationStatus.updatedBy = req.admin.id || req.admin._id;
        registrationStatus.updatedAt = new Date();
        
        await registrationStatus.save();
        
        res.json({
            success: true,
            message: `Registration is now ${activeStatus ? 'OPEN' : 'CLOSED'}`,
            data: {
                isActive: registrationStatus.isActive,
                message: registrationStatus.message,
                updatedAt: registrationStatus.updatedAt
            }
        });
    } catch (error) {
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while updating registration status' 
        });
    }
});

// TOGGLE registration status (simple toggle)
Adminroute.patch('/registration-status/toggle', authenticateAdmin, async (req, res) => {
    try {
        const registrationStatus = await RegistrationStatus.toggle(req.admin.id || req.admin._id);
        
        res.json({
            success: true,
            message: `Registration status toggled to: ${registrationStatus.isActive ? 'OPEN' : 'CLOSED'}`,
            data: {
                isActive: registrationStatus.isActive,
                message: registrationStatus.message,
                updatedAt: registrationStatus.updatedAt
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while toggling registration status' 
        });
    }
});

// UPDATE registration message only
Adminroute.patch('/registration-status/message', authenticateAdmin, async (req, res) => {
    try {
        const { message } = req.body;
        ...
        const registrationStatus = await RegistrationStatus.updateMessage(
            message.trim(), 
        ...
        res.json({
            success: true,
            message: 'Registration message updated',
            data: {
                isActive: registrationStatus.isActive,
                message: registrationStatus.message
            }
        ...
        console.error('Update registration message error:', error);
        res.status(500).json({ 
            success: false,
            error: 'Server error while updating message' 
        });
...
// ENABLE registration (shortcut)
Adminroute.post('/registration-status/enable', authenticateAdmin, async (req, res) => {
    try {
        const { message } = req.body;
        ...
        registrationStatus.isActive = true;
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while enabling registration' 
        });
    }
});

// DISABLE registration (shortcut)
Adminroute.post('/registration-status/disable', authenticateAdmin, async (req, res) => {
    try {
        const { message } = req.body;
        ...
        registrationStatus.isActive = false;
        ...
        res.status(500).json({ 
            success: false,
            error: 'Server error while disabling registration' 
        });
    }
});
