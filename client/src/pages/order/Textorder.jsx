      ...
      <div className={`rounded-2xl p-6 md:p-8 max-w-md w-full shadow-xl transition-colors duration-300 ${
        ...
        <div className="text-center">
          ...
          <p className={`text-sm md:text-base mb-4 md:mb-6 transition-colors duration-300 ${
            ...
            আপনার টেক্সট অর্ডারটি সফলভাবে প্লেস করা হয়েছে।
          </p>
              ...
              <div className={`p-4 rounded-lg border transition-colors duration-300 ${
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">টেক্সট</span>
                  </div>
                  <div className="flex justify-between">
                    <span className={`transition-colors duration-300 ${
                      isDarkMode ? 'text-gray-400' : 'text-gray-600'
...
function Textorder() {
  ...
  // Get text services and filtered text orders
  const textServices = services.textServices || [];
  const textOrders = getFilteredOrders('text');
  ...
  useEffect(() => {
    if (orderSuccessData && orderSuccessData.serviceType === 'text') {
  ...
  const filteredOrders = React.useMemo(() => 
    textOrders.filter(order =>
      order.serviceName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      order.status?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      order.orderId?.toLowerCase().includes(searchTerm.toLowerCase())
    ),
    [textOrders, searchTerm]
  );
  ...
  const handleDeleteOrder = async () => {
    ...
    try {
      ...
      if (data.success) {
        toast.success('টেক্সট অর্ডার সফলভাবে মুছে ফেলা হয়েছে');
        // Refresh orders list
        fetchOrders();
        // Close modals
        ...
        <main className={`min-h-[93vh] p-4 md:p-6 transition-colors duration-300 ${
          ...
          <div className={`border rounded-xl p-6 md:p-12 mb-6 flex flex-col items-center justify-center shadow-lg max-w-4xl mx-auto transition-colors duration-300 ${
            ...
            <p className={`text-sm md:text-lg mb-6 md:mb-8 text-center max-w-md transition-colors duration-300 ${
              ...
              সিস্টেমটি বর্তমানে অকার্যকর অবস্থায় রয়েছে। কাজ চালু হলে এখানে সব টেক্সট সেবা অপশন দেখতে পারবেন।
            </p>
            <button
    ...
    <div className={`font-anek lg:ml-72 mt-[9vh] transition-colors duration-300 ${
      ...
      <main className={`min-h-[93vh] p-4 md:p-6 transition-colors duration-300 ${
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 gap-4">
          <div>
            ...
            <p className={`text-xs md:text-sm lg:text-base mt-1 md:mt-2 transition-colors duration-300 ${
              ...
              আপনার প্রয়োজনীয় টেক্সট সেবা নির্বাচন করুন এবং দ্রুত অর্ডার সম্পন্ন করুন
            </p>
          </div>
          <div className="flex items-center gap-4">
            <div className={`text-xs md:text-sm transition-colors duration-300 ${
              ...
              মোট সেবা: <span className="font-bold text-green-600">{textServices.length}</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8 md:mb-10">
          {loading.textServices ? (
            <div className="flex justify-center items-center py-8">
              <ApertureLoader/>
            </div>
          ) : textServices.length === 0 ? (
            <div className={`border-2 border-dashed rounded-2xl p-6 md:p-12 text-center shadow-sm transition-colors duration-300 ${
              ...
              <p className={`text-base md:text-xl font-medium mb-1 md:mb-2 transition-colors duration-300 ${
                ...
                কোন টেক্সট সেবা পাওয়া যায়নি
              </p>
              <p className={`text-xs md:text-sm max-w-md mx-auto transition-colors duration-300 ${
                isDarkMode ? 'text-gray-500' : 'text-gray-500'
              }`}>
                বর্তমানে কোনো টেক্সট সেবা উপলব্ধ নেই। দয়া করে পরে আবার চেষ্টা করুন।
              </p>
            </div>
          ) : (
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 gap-4 md:gap-6">
              <div>
                ...
                <p className={`text-xs md:text-sm lg:text-base mt-1 md:mt-2 transition-colors duration-300 ${
                  ...
                  আপনার সকল টেক্সট অর্ডারের ইতিহাস এবং স্ট্যাটাস
                </p>
              </div>
...
// Memoize the text service card component
const TextServiceCard = memo(({ service, onClick, isDarkMode }) => (
  <div 
    onClick={onClick}
  ...
  >
    <div className="flex justify-between items-start mb-3 md:mb-4">
      <img className='w-[60px] md:w-[75px]' src={text_img} alt={service.workName} />
    </div>
