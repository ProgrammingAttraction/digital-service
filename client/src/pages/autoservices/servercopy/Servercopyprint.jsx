...
useEffect(() => {
  ...
  return (
    <div className="bg-zinc-200 min-h-screen py-5 print:p-0 print:bg-white">
      ...
      >
        ...
        {/* Content Section - flex-grow ensures footer stays at bottom if content is short */}
        <div className="px-10 py-6 flex gap-8 flex-grow">
          {/* Left Column: Photo & QR */}
          <div className="w-[160px] flex flex-col bg-white p-[5px] rounded-[5px] h-full items-center">
  ...
  />
          ...
          <div className="flex-1">
            <table className="w-full border-collapse table-fixed">
              <tbody>
                ...
                <DataRow label="ভোটার নাম্বার" value={data.voterNumber} />
                <DataRow label="ভোটার এলাকা নাম্বার" value={data.voterArea} />
                ...
                <DataRow label="রক্তের গ্রুপ" value={data.bloodGroup || 'O+'} />
                <DataRow label="পেশা" value={data.education || 'ছাত্র/ছাত্রী'} />

                <SectionHeader title="বর্তমান ঠিকানা" />
                <tr>
                  <td colSpan="2" className="p-3 text-[15px] print:text-[11px] leading-relaxed border border-[#ccc] bg-white">
                    {data.currentAddress}
                  </td>
                </tr>
        ...
        {/* Footer Info - Now positioned naturally at the bottom */}
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media print {
          ...
          /* Ensure images and tables don't cause page overflow */
