...
function Approveddeposit() {
  ...
  // Fetch approved deposits with filters
  const fetchDeposits = useCallback(async () => {
    try {
      ...
      const params = {
        ...
        status: 'approved', // Only fetch approved deposits
        ...filters
      };
  ...
  const handleBulkDelete = async () => {
    if (selectedDeposits.length === 0) {
      toast.error('Please select deposits to delete');
      return;
    }

    if (!window.confirm(`Are you sure you want to delete ${selectedDeposits.length} approved deposits? This will also reduce user balances.`)) {
      return;
    }
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute("download", `approved_deposits_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-gray-600">Today's Approved</p>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <h2 className="text-xl font-bold text-gray-800">Delete Approved Deposit</h2>
            </div>
            <button
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    This deposit is approved. Deleting it will reduce the user's balance by {selectedDeposit ? formatCurrency(selectedDeposit.amount + (selectedDeposit.bonusAmount || 0)) : 'the deposit amount'}.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <h2 className="text-xl font-bold text-gray-800">Approved Deposit Details</h2>
            </div>
            <button
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Approved: {formatDate(selectedDeposit.createdAt)}
                  </p>
                </div>
                <div className="inline-flex items-center px-3 py-1 rounded-full bg-green-100 text-green-800 border-[1px] border-green-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Status Changed By:</span>
                      <span className="font-medium">Admin</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Status Changed At:</span>
                      <span className="font-medium">
                        {selectedDeposit.statusChangedAt ? formatDate(selectedDeposit.statusChangedAt) : formatDate(selectedDeposit.createdAt)}
                      </span>
                    </div>
    ...
    <div className="font-anek text-gray-700 lg:ml-72 mt-[9vh]">
      ...
      <main className="min-h-screen bg-gray-50 p-4 md:p-6">
        <div className="w-full mx-auto">
          {/* Page Header */}
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-teal-600 mb-1">Approved Deposits</h1>
            <p className="text-gray-600 mt-1">View all approved user deposits</p>
          </div>
            ...
            <div className="overflow-x-auto">
              {loading ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-700">Loading approved deposits...</h3>
                </div>
              ) : deposits.length === 0 ? (
                <div className="text-center py-12">
                  <CheckCircle className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                  <h3 className="text-lg font-medium text-gray-700">No approved deposits found</h3>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {deposits.map((deposit) => (
                      <tr key={deposit._id} className="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="inline-flex items-center px-2.5 py-1.5 rounded-full text-xs font-medium bg-green-100 text-green-800 border-[1px] border-green-500">
              ...
              <div className="px-6 py-4 border-t border-gray-200">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-700">
                    ...
                    {Math.min(currentPage * itemsPerPage, totalItems)} of {totalItems} approved deposits
                  </div>
