...
function Userdetails() {
  ...
  const fetchUserDetails = async () => {
    try {
      ...
      const response = await axios.get(`${base_url}/api/sub-admin/users/${id}`, {
        headers: {
  ...
  const fetchUserTransactions = async () => {
    try {
      ...
      const response = await axios.get(`${base_url}/api/sub-admin/users/${id}/transactions`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchUserOrders = async () => {
    try {
      ...
      const response = await axios.get(`${base_url}/api/sub-admin/users/${id}/orders`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const handleEditUser = () => {
    navigate(`/admin/sub-admin/edit-details/${id}`);
  };
