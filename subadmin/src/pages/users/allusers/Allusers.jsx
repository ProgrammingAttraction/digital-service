...
// Modern Toggle Switch Component - FIXED LOGIC
...
function Allusers() {
  ...
  const fetchUsers = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`${base_url}/api/sub-admin/users`, {
        headers: {
  ...
  // Handle user status update - FIXED LOGIC
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div className="bg-white rounded-lg shadow p-4">
        ...
        <div className="mt-2 text-xs text-gray-500">
          <span className="text-green-600">Active: {statistics?.activeUsers || 0}</span>
          {' | '}
          <span className="text-yellow-600">Pending: {statistics?.pendingUsers || 0}</span>
        </div>
      </div>
    ...
    <div className="font-anek text-gray-700 lg:ml-72 mt-[9vh]">
      ...
      <main className="min-h-screen bg-gray-50 p-4 md:p-6">
        <div className="w-full mx-auto">
          {/* Page Header */}
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-teal-600 mb-1">All Users</h1>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 flex-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {(selectedFilters.status || selectedFilters.verified || selectedFilters.sort !== 'newest' || searchTerm) && (
                      <button
