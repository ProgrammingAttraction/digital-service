...
function Socialmedia() {
  ...
  const fetchSocialMedia = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${base_url}/api/sub-admin/social-media`, {
    ...
    try {
      ...
      if (editingId) {
        ...
        response = await axios.put(
          `${base_url}/api/sub-admin/social-media/${editingId}`,
          formData,
          { headers: { Authorization: `Bearer ${token}` } }
        );
        ...
        response = await axios.post(
          `${base_url}/api/sub-admin/social-media`,
          formData,
          { headers: { Authorization: `Bearer ${token}` } }
        );
  ...
  const handleDelete = async () => {
    ...
    try {
      setDeleting(true);
      await axios.delete(`${base_url}/api/sub-admin/social-media/${itemToDelete._id}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleToggleStatus = async (id, currentStatus) => {
    try {
      await axios.patch(
        `${base_url}/api/sub-admin/social-media/${id}/toggle`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
