...
function Completeorders() {
  ...
  const fetchOrders = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`${base_url}/api/sub-admin/orders/completed`, {
        headers: {
  ...
  const downloadPdfFile = async (orderId) => {
    try {
      const response = await axios.get(
        `${base_url}/api/sub-admin/orders/${orderId}/download-pdf`,
        {
          headers: {
            'Authorization': `Bearer ${token}`
          },
  ...
  const viewPdfFile = async (orderId) => {
    try {
      const response = await axios.get(
        `${base_url}/api/sub-admin/orders/${orderId}/view-pdf`,
        {
          headers: {
            'Authorization': `Bearer ${token}`
          },
