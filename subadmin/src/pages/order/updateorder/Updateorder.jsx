...
function Updateorder() {
  ...
  // Update order details - REMOVED SERVICE INFORMATION UPDATES
  const handleUpdateOrder = async () => {
    try {
      ...
      const response = await axios.put(
        ...
        {
          // REMOVED: serviceName, serviceType, serviceRate, quantity, totalAmount
...
const SubmitOrderModal = () => {
  // Move state inside the modal component
              ...
              {order.orderType === 'text_file' && (
                <div>
                  ...
                  <textarea
                    ...
                    autoFocus // This helps with focus
                  />
