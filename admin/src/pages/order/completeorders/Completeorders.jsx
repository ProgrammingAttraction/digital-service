...
function Completeorders() {
  ...
  // Fetch completed orders function
  const fetchOrders = useCallback(async () => {
    try {
      setLoading(true);
     
      const response = await axios.get(`${base_url}/api/admin/orders/completed`, {
        headers: {
      ...
      if (response.data.success) {
        ...
        if (response.data.count !== undefined) {
          setOrderStats(prev => ({
            ...
            completedOrders: response.data.count
          }));
        }
      }
    } catch (error) {
      console.error('Error fetching completed orders:', error);
      toast.error(error.response?.data?.error || 'Failed to fetch completed orders');
    } finally {
      setLoading(false);
    }
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div className="bg-white rounded-lg shadow p-4">
        ...
        <div className="mt-2 text-xs text-gray-500">
          <span className="text-green-600">Total Revenue: ৳{(statistics?.totalAmount || 0)?.toLocaleString()}</span>
        </div>
      </div>
      <div className="bg-white rounded-lg shadow p-4">
        <div className="flex items-center justify-between">
    ...
    <div className="font-anek text-gray-700 lg:ml-72 mt-[9vh]">
      ...
      <main className="min-h-screen bg-gray-50 p-4 md:p-6">
        <div className="w-full mx-auto">
          {/* Page Header */}
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-green-600 mb-1">Completed Orders</h1>
            <p className="text-gray-600 mt-1">View all successfully completed customer orders</p>
          </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 flex-1">
                  <div className="relative flex-1 max-w-md">
                    ...
                    <input
                      type="text"
                      placeholder="Search completed orders by order ID, customer, service..."
                      value={searchTerm}
                ...
                <div className="flex items-center gap-3">
                  {selectedOrders.length > 0 && (
                    <div className="flex items-center gap-3">
                      {/* Bulk Delete Selected Orders Button */}
                      <button
      ...
      <div className="flex space-x-2">
        ...
        <div className="animate-bounce h-3 w-3 bg-green-500 rounded-full" style={{ animationDelay: '300ms' }}></div>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-700">No completed orders found</h3>
                  <p className="text-gray-500 mt-1">Try adjusting your search or filters</p>
                  <button
                    onClick={clearAllFilters}
                    className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg cursor-pointer transition-colors duration-200"
                  >
                    Clear All Filters
                  </button>
                </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex items-center space-x-2">
                            ...
                            <button
                              ...
                              title={hasAdminOutput(order) ? 'Update Output' : 'View Output'}
                            >
                              <Send size={16} />
                            </button>
                            <button
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="text-sm text-gray-700">
                      ...
                      of <span className="font-medium">{totalItems}</span> completed orders
                    </div>
              ...
              <div className="flex">
                <div>
                  <p className="text-sm text-red-700 mt-1">
                    This action will permanently delete this completed order and all associated files.
          ...
          <div className="mb-6">
            <div className=" mb-4 bg-red-50 border-[1px] border-red-500 rounded-[10px] p-[20px]">
              <div className="flex">
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    This action will permanently delete {selectedOrders.length} selected completed orders and all associated files.
                    This cannot be undone!
                  </p>
              </div>
            </div>
