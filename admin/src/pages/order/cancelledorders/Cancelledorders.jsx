...
function Cancelledorders() {
  ...
  const fetchOrders = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`${base_url}/api/admin/orders/cancelled`, {
        headers: {
      ...
      if (response.data.success) {
        ...
        if (response.data.count !== undefined) {
          setOrderStats(prev => ({
            ...
            cancelledOrders: response.data.count
          }));
        }
      }
    } catch (error) {
      console.error('Error fetching cancelled orders:', error);
      toast.error(error.response?.data?.error || 'Failed to fetch cancelled orders');
    } finally {
      setLoading(false);
    }
  ...
  const handleBulkAction = async () => {
    ...
    try {
      const response = await axios.put(
        `${base_url}/api/admin/orders/bulk/status`,
        {
          orderIds: selectedOrders,
          status: bulkAction
        },
  ...
  const handleRestoreOrder = async (orderId) => {
    try {
      const response = await axios.post(
        `${base_url}/api/admin/orders/${orderId}/restore`,
        {},
        {
          headers: {
            'Authorization': `Bearer ${token}`,
      ...
      toast.error(error.response?.data?.error || 'Failed to restore order');
    }
  };
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div className="bg-white rounded-lg shadow p-4">
        ...
        <div className="mt-2 text-xs text-gray-500">
          <span className="text-red-600">Lost Revenue: ৳{(statistics?.totalAmount || 0)?.toLocaleString()}</span>
        </div>
      </div>
      <div className="bg-white rounded-lg shadow p-4">
        <div className="flex items-center justify-between">
      ...
      <div className="bg-white rounded-lg shadow p-4">
        <div className="flex items-center justify-between">
          ...
          <FaBangladeshiTakaSign className="w-8 h-8 text-red-500" />
        </div>
        <div className="mt-2 text-xs text-gray-500">
          Per cancelled order average
        </div>
      </div>
    </div>
  );
    ...
    <div className="font-anek text-gray-700 lg:ml-72 mt-[9vh]">
      ...
      <main className="min-h-screen bg-gray-50 p-4 md:p-6">
        <div className="w-full mx-auto">
          {/* Page Header */}
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-red-600 mb-1">Cancelled Orders</h1>
            <p className="text-gray-600 mt-1">View all cancelled customer orders</p>
          </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 flex-1">
                  <div className="relative flex-1 max-w-md">
                    ...
                    <input
                      type="text"
                      placeholder="Search cancelled orders by order ID, customer, service..."
                      value={searchTerm}
                  ...
                  {selectedOrders.length > 0 && (
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-[5px] cursor-pointer hover:bg-blue-700 text-sm font-medium transition-colors duration-200"
                      >
      ...
      <div className="flex space-x-2">
        ...
        <div className="animate-bounce h-3 w-3 bg-green-500 rounded-full" style={{ animationDelay: '300ms' }}></div>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-700">No cancelled orders found</h3>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="text-sm text-gray-700">
                      ...
                      of <span className="font-medium">{totalItems}</span> cancelled orders
                    </div>
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <h2 className="text-xl font-bold text-gray-800">Delete Cancelled Order</h2>
            </div>
            <button
              ...
              <div className="flex">
                <div>
                  <p className="text-sm text-red-700 mt-1">
                    This action will permanently delete this cancelled order and all associated files.
          ...
          <div className="mb-6">
            <div className=" mb-4 bg-red-50 border-[1px] border-red-500 rounded-[10px] p-[20px]">
              <div className="flex">
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    This action will permanently delete {selectedOrders.length} selected cancelled orders and all associated files.
                    This cannot be undone!
                  </p>
              </div>
            </div>
