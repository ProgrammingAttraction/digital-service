...
function Serviceslist() {
  ...
  const fetchStatistics = useCallback(async () => {
    try {
      const response = await axios.get(`${base_url}/api/admin/services/stats/overview`, {
        headers: {
  ...
  const handleToggleStatus = async (serviceId, currentStatus) => {
    try {
      ...
      const response = await axios.patch(
        `${base_url}/api/admin/services/${serviceId}/toggle-status`,
        {},
        {
          headers: {
            'Authorization': `Bearer ${token}`
  ...
  const handleDeleteService = async () => {
    try {
      const response = await axios.delete(
        `${base_url}/api/admin/services/${selectedService._id}`,
        {
          headers: {
            'Authorization': `Bearer ${token}`
          }
  ...
  const handleToggleFeatured = async (serviceId) => {
    try {
      const response = await axios.patch(
        `${base_url}/api/admin/services/${serviceId}/toggle-featured`,
        {},
        {
          headers: {
            'Authorization': `Bearer ${token}`
    ...
    try {
      if (action === 'delete') {
        ...
        for (const serviceId of selectedServices) {
          try {
            await axios.delete(`${base_url}/api/admin/services/${serviceId}`, {
              headers: {
                'Authorization': `Bearer ${token}`
              }
            });
        ...
        const response = await axios.put(`${base_url}/api/admin/services/bulk/status`, {
