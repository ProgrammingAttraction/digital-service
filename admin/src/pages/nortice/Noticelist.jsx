...
{ 
      ...
      notice: "জন্মনিবন্ধন ডাটা সেবা সক্রিয়",
      isActive: true 
    },
    ...
    { 
      ...
      notice: "আইএমইআই টু নাম্বার সেবা সক্রিয়",
      isActive: true 
    },
    { 
    ...
    // Newly Added Services from your request
    { 
      serviceName: "নাম্বার টু লোকেশন", 
      notice: "নাম্বার টু লোকেশন সেবা সক্রিয়",
      isActive: true 
    },
    { 
      serviceName: "IMEI TO NUMBAR", 
      notice: "IMEI টু নাম্বার সেবা পাওয়া যাচ্ছে",
      isActive: true 
    },
    { 
      serviceName: "এনআইডি ইউজার পাস", 
      notice: "এনআইডি ইউজার পাসওয়ার্ড রিসেট সেবা চলছে",
      isActive: true 
    },
    { 
      serviceName: "নতুন জন্ম নিবন্ধন", 
      notice: "নতুন জন্ম নিবন্ধন সেবা সক্রিয়",
      isActive: true 
    },
    { 
      serviceName: "টিন সার্টিফিকেট অর্ডার", 
      notice: "টিন সার্টিফিকেট অর্ডার সেবা চলছে",
      isActive: true 
    },
    { 
      serviceName: "জিরো রিটার্ন", 
      notice: "জিরো রিটার্ন সেবা পাওয়া যাচ্ছে",
      isActive: true 
    },
    { 
      serviceName: "এনআইডি টু অল নাম্বার", 
      notice: "এনআইডি টু অল নাম্বার সেবা সক্রিয়",
      isActive: true 
    },
    { 
      serviceName: "নাম ঠিকানা 2 এন আইডি", 
      notice: "নাম ঠিকানা টু এনআইডি সেবা চলছে",
      isActive: true 
    },
    { 
      serviceName: "স্মার্ট কার্ড অর্ডার", 
      notice: "স্মার্ট কার্ড অর্ডার সেবা সক্রিয়",
      isActive: true 
    },
    { 
      serviceName: "কার্ড অর্ডার", 
      notice: "কার্ড অর্ডার সেবা পাওয়া যাচ্ছে",
      isActive: true 
    },
    { 
      serviceName: "সার্ভার কপি অর্ডার", 
      notice: "সার্ভার কপি অর্ডার সেবা চলছে",
      isActive: true 
    },
    ...
    { 
      serviceName: "FORM No", 
      notice: "ফর্ম নং সেবা সক্রিয়",
      isActive: true 
    },
    { 
      serviceName: "NID No", 
      notice: "এনআইডি নম্বর সেবা পাওয়া যাচ্ছে",
      isActive: true 
    },
    { 
      serviceName: "Birth Number", 
      notice: "জন্ম নম্বর সেবা সক্রিয়",
      isActive: true 
    },
    { 
      serviceName: "Voter Number", 
      notice: "ভোটার নম্বর সেবা চলছে",
      isActive: true 
    },
    { 
      serviceName: "banglalink", 
      notice: "বাংলালিংক রিচার্জ সেবা সক্রিয়",
      isActive: true 
    },
    { 
      serviceName: "Robi", 
      notice: "রবি রিচার্জ সেবা পাওয়া যাচ্ছে",
      isActive: true 
    },
    { 
      serviceName: "Teletalk", 
      notice: "টেলিটক রিচার্জ সেবা সক্রিয়",
      isActive: true 
    },
    { 
      serviceName: "কল লিমিটে ৩ মাস", 
      notice: "৩ মাসের জন্য কল লিমিট সেবা চলছে",
      isActive: true 
    },
    { 
      serviceName: "কল লিমিটে ৬ মাস", 
      notice: "৬ মাসের জন্য কল লিমিট সেবা সক্রিয়",
      isActive: true 
    },
    { 
      serviceName: "ই-পাসপাউ", 
      notice: "ই-পাসপোর্ট সেবা পাওয়া যাচ্ছে",
      isActive: true 
    },
    { 
      serviceName: "এফআরসি পাসপোর্ট", 
      notice: "এফআরসি পাসপোর্ট সেবা সক্রিয়",
      isActive: true 
    }
  ];
  ...
  const saveDefaultNoticesToDB = async () => {
    try {
      const response = await axios.post(
        `${base_url}/api/admin/notices/save-defaults`,
  ...
  const checkAndSaveDefaults = async () => {
    try {
      const response = await axios.get(`${base_url}/api/admin/notices/check-defaults`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (response.data.data.length === 0) {
          ...
          const newResponse = await axios.get(`${base_url}/api/admin/notices`, {
            headers: {
              'Authorization': `Bearer ${token}`,
            }
          });
  ...
  const handleEditNotice = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${base_url}/api/admin/notices/${currentNotice._id}`,
        {
          serviceName: serviceName.trim(),
          notice: noticeText.trim(),
          isActive: isActive
  ...
  const handleToggleStatus = async (id, currentStatus) => {
    try {
      ...
      const response = await axios.patch(
        `${base_url}/api/admin/notices/${id}/toggle-status`,
        {},
        {
          headers: {
            'Authorization': `Bearer ${token}`,
                    ...
                    {filteredNotices.map((notice) => (
                      <tr key={notice._id} className="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          >
                            <span className={`w-2 h-2 rounded-full mr-2 ${notice.isActive ? 'bg-green-500' : 'bg-red-500'}`}></span>
            ...
            <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-end space-x-4 pt-6 ">
                  <button
                    onClick={() => setShowEditModal(false)}
                    className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors duration-150 cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-center space-x-4">
                <button
                  ...
                  className="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors duration-150 cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={loading}
                  className={`px-6 py-2 rounded-lg transition-colors duration-150 cursor-pointer ${
                    loading
