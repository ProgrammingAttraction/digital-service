...
import Newsubadmin from './pages/subadmin/Newsubadmin'
...
import Automethod from './pages/method/Automethod'
...
const App = () => {
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* -------------------sub-admin------------------------------ */}
      <Route path="/admin/sub-admin/new" element={
          <ProtectedRoute>
            <Newsubadmin />
          </ProtectedRoute>
        }/>
            <Route path="/admin/sub-admin/list" element={
          <ProtectedRoute>
            <Subadminlist />
          </ProtectedRoute>
        }/>
        
            <Route path="admin/subadmins/:id/edit" element={
          <ProtectedRoute>
            <Editsubadmin />
          </ProtectedRoute>
        }/>
    ...
    <Route path="/admin/payment-methods/edit/:id" element={
       ...
       <Route path="/admin/payment-methods/auto" element={
          <ProtectedRoute>
            <Automethod />
          </ProtectedRoute>
        }/>
 ...
 <Route path="/admin/orders/cancelled" element={
     ...
     {/* ----------------------------Menu list--------------------------- */}
      ...
      <Route path="/admin/menu-manage" element={
          <ProtectedRoute>
            <ManageMenu />
          </ProtectedRoute>
        }/>
     ...
     {/* ----------------------------Notice list--------------------------- */}
      ...
      <Route path="/admin/website-status" element={
          <ProtectedRoute>
            <WebsiteStatus />
          </ProtectedRoute>
        }/>

           <Route path="/admin/registration-manage" element={
          <ProtectedRoute>
            <RegistrationStatus />
          </ProtectedRoute>
        }/>
