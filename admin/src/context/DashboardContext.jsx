...
export const DashboardProvider = ({ children }) => {
  ...
  const updateAdminProfile = async (profileData) => {
    ...
    try {
      const response = await axios.put(`${base_url}/api/admin/profile`, profileData, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const changeAdminPassword = async (passwordData) => {
    ...
    try {
      const response = await axios.put(`${base_url}/api/admin/change-password`, passwordData, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
    ...
    try {
      ...
      switch(type) {
        case 'users':
          ...
          break;
        case 'orders':
          endpoint = `${base_url}/api/admin/orders`;
          break;
        case 'deposits':
          endpoint = `${base_url}/api/admin/deposits`;
          break;
        default:
